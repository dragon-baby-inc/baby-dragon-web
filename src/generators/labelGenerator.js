...
const createEditableOwerCheckbokLabel = ({
  exponent,
  fixedAmount,
  object,
  handleChange,
...
const createUserCheckbokLabel =
  ({ handleEdit, handleTrash }) =>
  ({ object, handleChange, selectedObjects }) => {
    let imageUrl = object.imageURL;
    if (!imageUrl) {
      imageUrl = userImageUrls[object.imageId];
    }
          ...
          <div>
            {object.fromLine ? null : (
              <div style={{ display: "flex", alignItems: "center" }}>
                ...
                {object.restrictedDestroy || !handleTrash ? null : (
                  <div
                    style={{ marginRight: "20px" }}
                    onClick={(e) => handleTrash(e, object)}
                  >
...
const createFreeUserCheckbokLabel =
  ({ handleEdit, handleTrash }) =>
  ({ object, handleChange, selectedObjects }) => {
    let imageUrl = object.imageURL;
    if (!imageUrl) {
