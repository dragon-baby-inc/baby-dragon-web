...
const useAccountingBook = (authState) => {
  ...
  const accountingBookUsersCache = store.get(
    `accountingBookUsers-${accounting_book_id}`
  );
  const [accountingBook, setAccountingBook] = useState(
    accountingBookCache ? accountingBookCache : {}
  );
  const [users, setUsers] = useState(
    accountingBookUsersCache ? accountingBookUsersCache : []
  );
  const [loading, setLoading] = useState(true);

  const stubUsers = [
    {
      id: "U4fb1cd3edb7c2552e2a25f286f5c102d",
      displayName: "Yen-jung Chen",
      imageURL: null,
      fromLine: true,
      coverCost: true,
    },
    {
      id: "CUSTOM-c75ab772b07bd3b70e4f345a",
      displayName: "小恩1號",
      imageURL: null,
      fromLine: false,
      coverCost: true,
    ...
    {
      id: "CUSTOM-99737d65a9022477c2533267",
      displayName: "小恩2號",
      imageURL: null,
      fromLine: false,
      coverCost: true,
    ...
    {
      id: "CUSTOM-8a5eabcef8067e18d3d4f1c3",
      displayName: "小恩3號",
      imageURL: null,
      fromLine: false,
      coverCost: true,
    ...
    {
      id: "CUSTOM-13b066ed3aef8beb35846063",
      displayName: "小恩4號",
      imageURL: null,
      fromLine: false,
      coverCost: true,
    ...
    {
      id: "CUSTOM-29e82848f7a2c6c097b5adbc",
      displayName: "小龍",
      imageURL: null,
      fromLine: false,
      coverCost: true,
    ...
    {
      id: "CUSTOM-eed1e996dfbf24cdfdd6f748",
      displayName: "小龍0號",
      imageURL: null,
      fromLine: false,
      coverCost: true,
    ...
    {
      id: "CUSTOM-cdf6ed2928e4f17c4e7854e5",
      displayName: "小龍1號",
      imageURL: null,
      fromLine: false,
      coverCost: true,
    ...
    {
      id: "CUSTOM-1d6c9fd5f5bff722720e5a9b",
      displayName: "小龍2號",
      imageURL: null,
      fromLine: false,
      coverCost: true,
    ...
    {
      id: "CUSTOM-12392d55aab175ba9cce09ca",
      displayName: "小龍3號",
      imageURL: null,
      fromLine: false,
      coverCost: true,
    ...
    {
      id: "CUSTOM-1e45c97974d994e80b903757",
      displayName: "小龍4號",
      imageURL: null,
      fromLine: false,
      coverCost: true,
    ...
    {
      id: "CUSTOM-3243610a4970d2a99f67f517",
      displayName: "小小龍",
      imageURL: null,
      fromLine: false,
      coverCost: false,
    ...
    {
      id: "CUSTOM-1866224c8f2f5ece35c582ed",
      displayName: "小恩0號",
      imageURL: null,
      fromLine: false,
      coverCost: false,
