...
class DragonBabyApi {
  ...
  getPayments(group_id, accounting_book_id, query) {
    return this.api.get(
      `api/v1/groups/${group_id}/accounting_books/${accounting_book_id}/payments${query}`
    );
  }

  getPayment(group_id, accounting_book_id, payment_id) {
    return this.api.get(
      `api/v1/groups/${group_id}/accounting_books/${accounting_book_id}/payments/${payment_id}`
    );
  }

  deletePayments(group_id, accounting_book_id, body) {
    return this.api.post(
      `api/v1/groups/${group_id}/accounting_books/${accounting_book_id}/payments/destroy_all`,
      body
    );
  }
  ...
  createPayment(group_id, accounting_book_id, params) {
    return this.api.post(
      `api/v1/groups/${group_id}/accounting_books/${accounting_book_id}/payments`,
      { payment: params }
    );
  }
  ...
  exportPayments(group_id, accounting_book_id) {
    return this.api.post(
      `api/v1/groups/${group_id}/accounting_books/${accounting_book_id}/payments/export`
    );
  }
  ...
  getAccountingBookSummary(group_id, accounting_book_id) {
    return this.api.get(
      `api/v1/groups/${group_id}/accounting_books/${accounting_book_id}/summary`
    );
  }

  getAccountingBook(group_id, accounting_book_id) {
    return this.api.get(
      `api/v1/groups/${group_id}/accounting_books/${accounting_book_id}`
    );
  }
  ...
  createAccountingBook(group_id, params) {
    return this.api.post(`api/v1/groups/${group_id}/accounting_books`, {
      accounting_book: params,
    });
  }
  ...
  updateCurrentAccountingBook(group_id, accounting_book_id) {
    return this.api.post(
      `api/v1/groups/${group_id}/accounting_books/${accounting_book_id}/set_as_current`
    );
  }
  ...
  updateCoverCostUsers(group_id, accounting_book_id, ids) {
    return this.api.post(
      `api/v1/groups/${group_id}/accounting_books/${accounting_book_id}/users`,
      { accounting_book_user_ids: ids }
    );
  }

  updateCoverCostUser(group_id, accounting_book_id, ids) {
    return this.api.post(
      `api/v1/groups/${group_id}/accounting_books/${accounting_book_id}/user`,
      { accounting_book_user_ids: ids }
    );
  }
  ...
  getLogMessages(group_id, accounting_book_id) {
    return this.api.get(
      `api/v1/groups/${group_id}/accounting_books/${accounting_book_id}/log_messages`
    );
  }
}
