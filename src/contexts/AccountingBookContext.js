...
const AccountingBookReducer = (state, action) => {
  switch (action.type) {
    ...
    case 'set_currency':
      return { ...state, currency: { value: action.payload.value, valid: action.payload.valid } };
    case 'set_users':
      return { ...state, users: { value: action.payload.value, valid: action.payload.valid } };
...
const setUsers = dispatch => ({ value, valid }) => {
  dispatch({ type: 'set_users', payload: { value, valid } })
}

const setCurrency = dispatch => ({ value, valid }) => {
